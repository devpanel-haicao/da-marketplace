        ...
        <div class="container">
            ...
            <div class="section-page-title">
              ...
              <div class="template-actions">
                <a href="https://dev-e14008-d0976a-b2q0m213neiq.apps-drupalforge.click/" class="template-launch"><i class="fa-solid fa-rocket"></i> Demo</a>
    ...
    <main class="main">
        <div class="container">
            <div class="block-feature">
                <img src="images/byte-home.webp" alt="Byte Blog">
            </div>

            <div class="main-content-wrap">
                <div class="main-content">
                    <p>Designed for a SaaS product website, this template includes drag-and-drop landing pages, a blog, newsletter sign up and other features as well as curated add-ons targeted at product sites.</p>
                    <p>Key features:</p>
                    
                    <ul>
                        <li>Elegant, dark design</li>
                        ...
                        <li>Blog content type and content listings</li>
                    ...
                    <div class="block-tags">
                        ...
                        <div class="block-content">
                            <div class="values">
                                ...
                                <div class="value">Portfolio &amp; Agency</div>
                                <div class="value">Technology and SaaS</div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="template-tabs">
                <div class="horizontal-tabs">
                    ...
                    <div class="horizontal-tabs-panes">
                        ...
                        <div id="edit-group-support" class="horizontal-tabs-pane" style="display: none;">
                            <div>
                                <div class="label">Support link</div>
                                <div class="values">
                                    <a href="https://www.drupal.org/project/cms#support">https://www.drupal.org/project/cms#support</a>
                                </div>
                            </div>
                        </div>
                    </div>
